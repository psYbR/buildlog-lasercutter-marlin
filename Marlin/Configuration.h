...
#define HOMING_FEEDRATE {50*40, 50*40, 0, 0}  // set the homing speeds (mm/min)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.82,78.82,4000,500}  // default steps per unit for Ultimaker
